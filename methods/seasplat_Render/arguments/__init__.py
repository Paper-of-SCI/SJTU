...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # 3D medium field used by the default --do_seathru path.
        self.medium_lr = 2.0e-4
        self.medium_samples = 4
        self.medium_hidden_dim = 32
        self.medium_density_bias = -4.0
        self.medium_far = 0.0
        self.medium_chunk_pixels = 65536
        self.medium_max_density = 10.0
        self.medium_max_optical_depth = 80.0
        self.lambda_medium = 1.0e-3
        self.lambda_beta = 1.0e-2
        self.lambda_decor = 1.0e-2
        self.medium_warmup_steps = 0
